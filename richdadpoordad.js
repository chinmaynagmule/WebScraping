...
async function getPageData(url,page){
  ...
  const isbn = await page.$eval("#productOverview > div.col-xs-14.right-card-zoom.reset-padding > div > div.pdp-elec-topcenter-inner.layout > div.highlightsTileContent.highlightsTileContentTop.clearfix > div > ul > li:nth-child(1) > span.h-content", isbn => isbn.textContent);
